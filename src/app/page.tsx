...
export default function Home() {
    ...
    const [livePrices, setLivePrices] = useState<{ [key: string]: number }>({ BTCUSDT: 0, ETHUSDT: 0, SOLUSDT: 0, BNBUSDT: 0 });
    const [priceChanges24hMap, setPriceChanges24hMap] = useState<{ [key: string]: number }>({ BTCUSDT: 0, ETHUSDT: 0, SOLUSDT: 0, BNBUSDT: 0 });
    const [volumes24hMap, setVolumes24hMap] = useState<{ [key: string]: number }>({ BTCUSDT: 0, ETHUSDT: 0, SOLUSDT: 0, BNBUSDT: 0 });
    const [gridActiveMap, setGridActiveMap] = useState<{ [key: string]: boolean }>({ BTCUSDT: false, ETHUSDT: false, SOLUSDT: false, BNBUSDT: false });
        ...
        <div className="flex flex-col h-screen max-h-screen overflow-hidden text-slate-100 bg-[#08090c]">
            ...
            <header className="flex items-center justify-between px-6 py-1 bg-[#11141c]/70 backdrop-blur-md border-b border-white/5 h-16 shadow-lg">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col items-end">
                        <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Position Status</span>
                                ...
                                <table className="w-full border-collapse text-left text-[11px]">
                                    <thead>
                                        <tr className="bg-slate-950/45 text-slate-500 border-b border-white/5 font-semibold sticky top-0 z-10 uppercase tracking-wider text-[9px]">
                                            ...
                                            <th className="py-2 px-4">Margin</th>
                            ...
                            <table className="w-full border-collapse text-left text-[11px]">
                                <thead>
                                    <tr className="bg-slate-950/45 text-slate-500 border-b border-white/5 font-semibold sticky top-0 z-10 uppercase tracking-wider text-[9px]">
                                        ...
                                        <th className="py-2 px-4">Margin/Capital</th>
                                ...
                                <tbody className="font-mono text-slate-300">
                                    {openPositions.length === 0 ? (
                                        <tr className="text-center font-sans text-slate-500">
                                            <td colSpan={8} className="py-12">No open positions.</td>
                                        </tr>
                                    ) : (
